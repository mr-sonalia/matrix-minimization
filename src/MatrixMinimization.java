...
public class MatrixMinimization {
	...
	JButton creditB = new JButton("Members");
	// DROP DOWN
	...
	public static void main(String[] args) { // MAIN METHOD
		new MatrixMinimization();
	}

	public MatrixMinimization() { // CONSTRUCTOR
		clearMap();
		initialize();
	}
	...
	private void initialize() { // INITIALIZE THE GUI ELEMENTS
		...
		frame.setTitle("Matrix Minimization");
			...
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(frame,
						"                         Project By:\n"
								...
								+ "                         Nilabja Dey\n"
								+ "                         Anirudhya Paul\n",
						"Team Members", JOptionPane.PLAIN_MESSAGE,
						new ImageIcon(""));
			}
		});
